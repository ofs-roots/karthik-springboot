...
public class CustomerResource {
    ...
    public void createCart(@RequestBody Map<String, String> parameters) {

        customerService.createCart(parameters);
    }
    ...
    public ResponseEntity<List<CartProduct>> getCart() {
        ...
        List<CartProduct> response = customerService.getCart();
        return new ResponseEntity<List<CartProduct>>(response, HttpStatus.OK);
    }
}